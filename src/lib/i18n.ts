...
const en: TranslationDict = {
  ...
  "session.viewDiff": "View code diff",
  ...
  "diff.fileCount": "{n} file(s)",
  "diff.toggleWrap": "Toggle line wrap",
  "diff.hideSidebar": "Hide file tree",
  "diff.showSidebar": "Show file tree",
  "dialog.close": "Close",
  ...
  "input.queueAdd": "Queue this message",
  "input.queueTitle": "Queue",
  "input.queueHint": "Will run after current task",
  "input.queueRemove": "Remove from queue",
  ...
  "input.acCommands": "Commands & Skills",
  "input.acFiles": "Project Files",
  ...
  "chat.fromLark": "Forwarded from Lark client",
  ...
  "settings.testModel": "Test availability",
  "settings.testOk": "Available",
  "settings.testFailed": "Unavailable",
  "settings.revealKey": "Show API key",
  ...
  "settings.addModelTitle": "Add a new model",
  "settings.provider": "Provider",
  "settings.modelId": "Model ID",
  "settings.modelIdHint": "Enter the model identifier you want to call.",
  "settings.baseUrlOverrideHint": "Default is the pay-as-you-go endpoint. Edit if you use a Token Plan or dedicated endpoint.",
  "settings.testAndAdd": "Test & add",
  ...
  "update.newVersionNotes": "What's new in v{version}",
  "update.installedNotes": "Welcome to v{version}",
  "update.noNotes": "No release notes provided.",
  "update.close": "Close",
  "update.notesForVersion": "v{version} · Released {date}",
  "changelog.title": "Changelog",
  "changelog.empty": "No changelog entries.",
  "changelog.noNotes": "No notes for this version.",
  "changelog.current": "Current",
  "changelog.viewHistory": "Changelog",
...
const zh: TranslationDict = {
  ...
  "diff.toggleWrap": "切换换行",
  "diff.hideSidebar": "隐藏文件树",
  "diff.showSidebar": "显示文件树",
  "dialog.close": "关闭",
  ...
  "input.queueAdd": "加入队列",
  "input.queueTitle": "队列",
  "input.queueHint": "当前任务结束后自动执行",
  "input.queueRemove": "从队列移除",
  "input.model": "切换模型",
  "input.mode": "模式：",
  ...
  "settings.testModel": "测试可用性",
  "settings.testOk": "可用",
  "settings.testFailed": "不可用",
  "settings.revealKey": "显示 API 密钥",
  ...
  "settings.addModelTitle": "添加新模型",
  "settings.provider": "模型厂商",
  "settings.modelId": "模型 ID",
  "settings.modelIdHint": "填写需要调用的模型标识符。",
  "settings.baseUrlOverrideHint": "默认为按量付费端点。如使用 Token Plan 或专属端点，可直接修改。",
  "settings.testAndAdd": "测试并添加",
  "settings.getApiKey": "获取 API Key",
  "settings.cancel": "取消",
  "provider.anthropic": "Anthropic",
  "provider.zhipu": "智谱 GLM",
  "provider.moonshot": "月之暗面 Kimi",
  "provider.qwen": "通义千问",
  "provider.minimax": "MiniMax",
  ...
  "update.newVersionNotes": "v{version} 有什么新功能",
  "update.installedNotes": "欢迎使用 v{version}",
  "update.noNotes": "暂无更新日志。",
  "update.close": "关闭",
  "update.notesForVersion": "v{version} · 发布于 {date}",
  "changelog.title": "更新日志",
  "changelog.empty": "暂无更新记录。",
  "changelog.noNotes": "该版本无详细说明。",
  "changelog.current": "当前",
  "changelog.viewHistory": "更新日志",
